...
export type WorkerMessage =
  | { type: "worker_hello"; workerId: string; repo: string; taskId?: string; status: "ready" | "reserved" | "assigned" | "revive"; workerSecret?: string; lastSeenEventSeqId?: number; githubToken?: string; version?: string; protocolVersion?: number }
