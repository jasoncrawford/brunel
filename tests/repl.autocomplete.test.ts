...
import { CommandRegistry, parseFrontmatter, listSkillNames, matchCommands, filterCommands, type ListDir, type CommandSuggestion } from "../src/agent/command-registry.js";
