...
- `shared/` — utilities needed by both Node backend and Vite frontend: `wire.ts` (wire protocol types, `PROTOCOL_VERSION`, and `DEFAULT_TASK_LABEL`), `formatters.ts` (pure data-to-string helpers)
